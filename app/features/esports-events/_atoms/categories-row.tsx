  ...
  return (
    <div className="flex items-center gap-1.5">
      <div className="relative h-[13px] w-[21px]">
        <span className={cn(flagElementClasses)} />
        <span className={cn(flagElementClasses, 'w-3', 'left-1', 'opacity-30')} />
        <span className={cn(flagElementClasses, 'w-5', 'left-px', 'opacity-30')} />
      </div>
